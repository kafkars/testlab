...
pub(crate) fn dispatch<W: Write>(
    ...
    match command {
        ...
        AdapterCommand::DescribeLogDirs(command) => {
            crate::protocol_admin_log_dirs::describe(state, writer, command_id, command)
        }
        ...
        AdapterCommand::AlterReplicaLogDirs(command) => {
            crate::protocol_admin_replica_log_dirs::alter(state, writer, command_id, command)
        }
        ...
        command @ AdapterCommand::ElectLeaders(_) => {
