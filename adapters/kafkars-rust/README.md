...
2. implements protocol v36 over stdin/stdout;
...
8. executes metadata-backed and explicit `DescribeTopicPartitions` topic
   ...
   batches, plural offset mutations, and dedicated classic-group descriptions
   as one bounded public call with per-resource outcomes;
