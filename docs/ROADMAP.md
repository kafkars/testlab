...
- Real-Kafka scenarios cover producing, assigned, group, and share consumption;
  topic creation, partition expansion, scoped topic discovery, latest-offset,
  and committed consumer-group offset administration; transactions, fencing,
  broker restart, and rolling restart.
