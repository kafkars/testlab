...
Protocol v155 is UTF-8 JSON Lines over stdin and stdout.
This cut pairs it with scenario schema v159 and evidence schema v145.
...
Protocol v155 is an exact semantic contract. New capabilities may be declared
