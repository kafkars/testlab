...
Protocol v151 is UTF-8 JSON Lines over stdin and stdout.
This cut pairs it with scenario schema v155 and evidence schema v141.
...
Protocol v151 is an exact semantic contract. New capabilities may be declared
