//! Producer cancellation catalog tests retain the scenario in every capable pack.
...
#[test]
fn capable_kafkars_packs_retain_producer_cancellation() {
    ...
    for path in [
        ...
        "packs/kafkars-producer-cancellation.toml",
    ] {
        ...
        assert!(
            pack.scenarios
                .iter()
                .any(|scenario| scenario.ends_with("producer-cancellation.toml")),
            "{path} omitted producer cancellation"
        );
    }
}
