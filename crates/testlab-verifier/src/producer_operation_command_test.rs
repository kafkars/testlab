//! Tests for the producer operation command contract.

use testlab_schema::{
    AdapterCommand, HistoryEntry, HistoryPayload, OperationId, ProducerId, ProducerPartitioning,
    ProducerSendMethod, Scenario,
};
