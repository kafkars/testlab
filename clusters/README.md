...
leader replacement requires both producer and directly assigned consumer
progress before restoration. Leader discovery uses librdkafka and remains
security-profile aware. The
